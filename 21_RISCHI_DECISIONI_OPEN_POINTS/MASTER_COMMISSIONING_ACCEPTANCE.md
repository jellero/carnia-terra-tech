# Master commissioning & end-to-end acceptance — Carnia TerraTech

**Aggiornato:** 18 settembre 2026  
**Stato:** `MASTER SAT / ESECUZIONE DA IMPIANTO REALE`

## 1. Obiettivo

Definire una sola sequenza di commissioning che dimostri che i sottosistemi funzionano:
- singolarmente;
- nelle interfacce;
- in failure mode;
...
Il go-live non è la somma dei singoli "ON".
...
## 3. Gate prima del SAT end-to-end
...
- open punch list classificata.

## 4. Sequenza commissioning

### C0 — documentazione e static checks
- serial/model check;
- CE/DoC/certificati;
- torque/termination;
- labeling;
...
### C1 — energization / dry commissioning
...
- residual punch list has owner/date/risk.
...
| SAT-EL-02 | BESS | full charge/discharge | sì | capacity/power/telemetry within vendor acceptance |
...
## 7. Thermal/climate commissioning
...
A warm-weather commissioning cannot close winter performance; mark seasonal SAT open.

## 8. Cold-chain commissioning
...
## 9. Server/automation commissioning
...
No go-live if accounting state can diverge from physical inventory without a recovery procedure.

## 12. Integrated blackout scenario
...
## 13. Integrated server-loss scenario
...
- acknowledgement;
- recovery condition;
- no duplicate alarms across PLC/server/vendor;
...
## 18. Seasonal acceptance

Some tests cannot be honestly closed in one commissioning window.
...
Retention/warranty/payment terms should preserve vendor obligation until seasonal SAT where contractually possible.
...
- supplier punch closure.

At day 30:
- commissioning closeout review;
- update CAPEX/OPEX;
- update SOP/PM;
- update spares;
